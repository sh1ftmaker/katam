...
{
    struct Task *t = TaskCreate(sub_080B0C40, sizeof(struct Object4), 0x3500, TASK_USE_EWRAM, ObjectBaseDestroy);
    ...
    if (Macro_0810B1F4(&leap->base))
        heart->flags |= 0x2000;
    Object4InitSprite(heart, &heart->sprite, 0xC, 0x313, 0, 0xC);
