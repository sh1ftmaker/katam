...
void sub_08000460(void)
{
    ...
    for (i = 0; i < 4; i++) {
        ...
        struct Background *bg0;

        levelInfo->currentRoom |= 0xFFFF;
        levelInfo->unk65C |= 0xFFFF;

        bg1 = &levelInfo->unkC0[1];
        bg1->tilesVram = 0x06008000;
        bg1->unkA = 0;
        bg1->tilemapVram = 0x0600F000;
        bg1->unk18 = 0;
        bg1->unk1A = 0;
        bg1->unk1C = i;
        bg1->unk1E = 0;
        ...
        bg1->scrollX = 0;
        bg1->scrollY = 0;
        bg1->prevScrollX = 0x7FFF;
        bg1->prevScrollY = 0x7FFF;

        bg2 = &levelInfo->unkC0[2];
        bg2->tilesVram = 0x06000000;
        bg2->unkA = 0;
        bg2->tilemapVram = 0x0600F800;
        bg2->unk18 = 0;
        bg2->unk1A = 0;
        bg2->unk1C = i + 4;
        bg2->unk1E = 0;
        ...
        bg0 = &levelInfo->unkC0[0];
        bg0->tilesVram = 0x06008000;
        bg0->unkA = 0;
        bg0->tilemapVram = 0x0600E800;
        bg0->unk18 = 0;
        bg0->unk1A = 0;
        bg0->unk1C = i + 8;
        bg0->unk1E = 0;
